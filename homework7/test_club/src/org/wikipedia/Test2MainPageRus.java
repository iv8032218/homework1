...
public class Test2MainPageRus {
    ...
    @Test
    public void testMainPageRus() throws Exception {
        driver.get(baseUrl + "/");
        ...
        try {
            assertEquals("Читать", driver.findElement(By.cssSelector("#ca-view > span > a")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("", driver.findElement(By.cssSelector("img[alt=\"Доп. действия\"]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("Обсудить", driver.findElement(By.cssSelector("a[title=\"Обсуждение шаблона:Знаете ли вы\"] > span.mw-ui-button")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
            assertEquals("", driver.findElement(By.xpath("(//img[@alt='Доп. действия'])[5]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("", driver.findElement(By.xpath("(//img[@alt='Доп. действия'])[2]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("", driver.findElement(By.xpath("(//img[@alt='Доп. действия'])[6]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("", driver.findElement(By.xpath("(//img[@alt='Доп. действия'])[3]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("", driver.findElement(By.xpath("(//img[@alt='Доп. действия'])[7]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
        ...
        try {
            assertEquals("", driver.findElement(By.xpath("(//img[@alt='Доп. действия'])[8]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
    }
